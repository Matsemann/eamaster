...
package com.matsemann.testing.simulator.bullet;
...
public class BulletTestCollection extends GdxTest implements InputProcessor, GestureListener {
	protected final BulletTest[] tests = { new MeshShapeTest(),new SoftMeshTest(), new SoftBodyTest(), new BasicBulletTest(), new ShootTest(), new BasicShapesTest(), new KinematicTest(),
		new ConstraintsTest(), new GimpactTest(), new ConvexHullTest(), new ConvexHullDistanceTest(),
		...
		new ContactCacheTest(), new VehicleTest(), new CharacterTest(), new ImportTest()};
