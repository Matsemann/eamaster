...
public class Executor extends ProblemBuilder {
	 ...
	 * {@link org.moeaframework.util.progress.ProgressListener}s.
	 */
	...
	/**
	 * Sets the {@link java.util.concurrent.ExecutorService} used by this executor to distribute
	 ...
	 * 
	 * @return a reference to this executor
	 * @throws java.io.IOException if the checkpoint file could not be deleted
	 */
