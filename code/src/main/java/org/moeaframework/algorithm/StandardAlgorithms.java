...
public class StandardAlgorithms extends AlgorithmProvider {
	...
	/**
	 * Returns a new {@link org.moeaframework.algorithm.NSGAII} instance.
	 * 
	...
	/**
	 * Returns a new {@link org.moeaframework.algorithm.MOEAD} instance.  Only real encodings are supported.
	 * 
	 * @param properties the properties for customizing the new {@code MOEAD}
	 *        instance
	 * @param problem the problem
	 * @return a new {@code MOEAD} instance
	 * @throws org.moeaframework.core.FrameworkException if the decision variables are not real valued
	 */
	...
	/**
	 * Returns a new {@link org.moeaframework.algorithm.GDE3} instance.  Only real encodings are supported.
	 * 
