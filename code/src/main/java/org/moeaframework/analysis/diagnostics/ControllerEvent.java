...
public class ControllerEvent extends EventObject {
	...
	public static enum Type {
		 ...
		 * determined by invoking {@link org.moeaframework.analysis.diagnostics.Controller#isRunning()}.
		 */
		STATE_CHANGED,
		 ...
		 * can be queried through {@link org.moeaframework.analysis.diagnostics.Controller#getRunProgress()} and
		 * {@link org.moeaframework.analysis.diagnostics.Controller#getOverallProgress()}.
		 */
		PROGRESS_CHANGED,
		
		/**
		 * Indicates the viewing options changed.  These events are primarily
		 * caused by changing how the data is plotted in {@link org.moeaframework.analysis.diagnostics.DiagnosticTool}.
		 */
		VIEW_CHANGED
