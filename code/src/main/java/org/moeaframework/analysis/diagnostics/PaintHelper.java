...
import com.matsemann.ea.PlotColors;
...
public class PaintHelper {
	...
	/**
	 * The mapping from seeds to their assigned {@link java.awt.Paint}.
	 */
	private PaintMap paintMap;
	
	/**
	 * The index of the next {@link java.awt.Paint} to be returned by
	 ...
	 */
	private static final Paint[] PAINTS = PlotColors.createDefaultPaintArray();
