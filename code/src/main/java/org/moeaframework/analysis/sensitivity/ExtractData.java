 ...
 * <ul>
 *   <li>{@code +hypervolume} for {@link org.moeaframework.core.indicator.Hypervolume}
 *   <li>{@code +generational} for {@link org.moeaframework.core.indicator.GenerationalDistance}
 *   <li>{@code +inverted} for {@link org.moeaframework.core.indicator.InvertedGenerationalDistance}
 *   <li>{@code +epsilon} for {@link org.moeaframework.core.indicator.AdditiveEpsilonIndicator}
 *   <li>{@code +error} for {@link org.moeaframework.core.indicator.MaximumParetoFrontError}
 *   <li>{@code +spacing} for {@link org.moeaframework.core.indicator.Spacing}
 *   <li>{@code +contribution} for {@link org.moeaframework.core.indicator.Contribution}
 * </ul>
 */
public class ExtractData extends CommandLineUtility {
	 ...
	 * prior to calling this method.  An {@link org.moeaframework.util.OptionCompleter} is used to
	 ...
	 * @throws org.moeaframework.core.FrameworkException if the command is not supported
	...
	protected String evaluate(String command, ResultEntry entry, 
		...
		if (option.equals("hypervolume")) {
			...
			indicator = new Spacing(problem, referenceSet);
