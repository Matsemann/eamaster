 ...
 * See {@link org.moeaframework.problem.ExternalProblem} for details on developing an external problem.
 */
public class Solve extends CommandLineUtility {
	 ...
	 * @throws org.apache.commons.cli.ParseException if an error occurred while parsing the variable
	 *         specification
	 */
	 ...
	 * @throws org.apache.commons.cli.ParseException if an error occurred parsing any of the command
	 *         line options
	 * @throws java.io.IOException if an error occurred starting the external program
	 */
