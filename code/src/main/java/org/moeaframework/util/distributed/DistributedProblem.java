...
/**
 * Distributes the {@link #evaluate(org.moeaframework.core.Solution)} method across multiple threads,
 * cores or compute nodes using the provided {@link java.util.concurrent.ExecutorService}. The
 * {@code ExecutorService} defines the type and method of distribution. The
 * problem must be {@link java.io.Serializable} if executing on remote nodes.
 */
public class DistributedProblem implements Problem {
	...
	/**
	 * The {@link java.util.concurrent.Callable} sent to the {@code ExecutorService} for distributed
